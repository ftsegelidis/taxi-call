...
public class LoginActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //Παιρνουμε τα δεδομενα (αν υπαρχουν) απο το αρχειο που ορισαμε
	...
	class checkLoginTask extends AsyncTask<String, Boolean, String> {
		...
		protected String doInBackground(String... args) {
    		...
    		try {
    			 ...
    			 myjobg = json.makeHttpRequest(globalVariables.getInstance().getBASE_PATH()+"/scripts/makeLogin.php","POST",parameters);
