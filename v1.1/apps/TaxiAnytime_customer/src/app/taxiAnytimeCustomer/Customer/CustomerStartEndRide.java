...
private void confirmOrder(){
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		if(keyCode == KeyEvent.KEYCODE_BACK && btnStart.isEnabled() ){
			
			confirmOrder();
			
		}
		else if(keyCode == KeyEvent.KEYCODE_HOME && btnStart.isEnabled() ){
			confirmOrder();
		}
...
//====================================================================================
     ...
     * 
     * */
	protected class CustomerConfirmOrderTask extends AsyncTask<String, Void, String> {
