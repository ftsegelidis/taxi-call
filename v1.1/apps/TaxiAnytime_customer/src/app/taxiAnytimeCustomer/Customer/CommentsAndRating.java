...
//=====================================================
	 ...
	 */
protected class CreateCommentTask extends AsyncTask<String, Void, String> {
	...
	/**
		...
		protected String doInBackground(String... args) {
			...
			try {
				...
				myjobg = json.makeHttpRequest(globalVariables.getInstance().getBASE_PATH()+"/scripts/makeCommentsRatings.php",parameters);
