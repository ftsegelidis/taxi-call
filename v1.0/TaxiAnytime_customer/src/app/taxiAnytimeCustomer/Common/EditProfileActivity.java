		 ...
		 @Override
	        ...
	        protected String doInBackground(String... urls) {
					...
					try {
						...
						myjobg = json.makeHttpRequest(globalVariables.getInstance().getBASE_PATH()+"/scripts/fetchDataToEdit.php","POST",parameters);
...
class makeEditTask extends AsyncTask<String, String, String> {
		...
		private boolean check;
				...
				try {	
		    		...
		    		parameters.add(new BasicNameValuePair("deviceid", prefs.getString("customerdevid","") ) );
		    		parameters.add(new BasicNameValuePair("usertype","customer") );
		 
					myjobg = null; 
					json = new httpJSONParser();
		    	    myjobg = json.makeHttpRequest(globalVariables.getInstance().getBASE_PATH()+"/scripts/makeEdit.php","POST",parameters);
